...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_loader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/loader.js */ \"./src/components/loader.js\");\n/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./css/style.css */ \"./src/css/style.css\");\n/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_css_style_css__WEBPACK_IMPORTED_MODULE_1__);\n\n ///WAY  2////\n\nvar ul = document.createElement('ul');\nul.setAttribute('style', 'padding:0');\nul.setAttribute('class', 'row');\nvar html = '';\n\nvar serviceApi = function serviceApi(searchKey) {\n  Object(_components_loader_js__WEBPACK_IMPORTED_MODULE_0__[\"loaderShow\"])('show');\n  fetch(\"https://www.googleapis.com/books/v1/volumes?q=\".concat(searchKey)).then(function (response) {\n    if (!response.ok) {\n      throw new Error(\"Could load json.\");\n    }\n\n    return response.json();\n  }) // Transform data to json\n  .then(function (data) {\n    console.log(data);\n    var listItem = data.items; // Get data\n\n    Object(_components_loader_js__WEBPACK_IMPORTED_MODULE_0__[\"loaderHide\"])('show'); // Map each\n\n    return listItem.map(function (listItem) {\n      //generate HTML\n      var htmlsec = \"<div class=\\\"book-column \\\">\\n  <div class=\\\"book-card\\\">\\n    <div class=\\\"book-list-content\\\">\\n        <div class=\\\"book-card-image\\\">\\n            <img src=\".concat(listItem.volumeInfo.imageLinks.thumbnail, \" alt=\\\"\\\"> \\n        </div>\\n        <div class=\\\"book-card-body\\\">\\n            <div class=\\\"book-header\\\">\\n                <h4 class=\\\"book-title book-hight-text\\\">Title: \").concat(listItem.volumeInfo.title.substr(0, 40), \"</h4>\\n                <h4 class=\\\"book-author book-hight-text\\\">Author: \").concat(listItem.volumeInfo.authors, \"</h4>\\n                <h4 class=\\\"book-el-link book-hight-text\\\"><a href=\\\"\").concat(listItem.volumeInfo.canonicalVolumeLink, \"\\\" >\").concat(listItem.volumeInfo.title, \" </a></h4>\\n            </div>\\n            <div class=\\\"book-details\\\">\\n                <h5 class=\\\"book-publisher book-hight-text\\\">Publisher: \").concat(listItem.volumeInfo.publisher, \"</h5>\\n                <h5 class=\\\"book-id-number\\\">Id Number: \").concat(listItem.id, \"</h5>\\n            </div>\\n            <div class=\\\"\\\">\\n               <span class=\\\"book-badge book-badge-blue\\\"> \").concat(listItem.volumeInfo.pageCount, \" p </span>\\n               <span class=\\\"book-badge book-badge-green\\\"> \").concat(listItem.volumeInfo.language, \" </span>\\n               <span class=\\\"book-badge book-badge-red\\\"> #\").concat(listItem.volumeInfo.categories, \" </span>\\n            \\n            \\n            </div>\\n        </div>\\n    </div>\\n  </div>\\n  </div>\");\n      html += htmlsec;\n      var rows = document.querySelector('.row');\n      rows.innerHTML = html;\n    });\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n  var html = '';\n};\n\nserviceApi('[]'); //////\n\nvar inputs = document.querySelector('.search');\nvar btnSearch = document.querySelector('.btn-search');\nconsole.log(inputs); //let vals = inputs.value;\n//console.log(vals)\n//   inputs.addEventListener('input', evt => {\n//       const value = inputs.value.trim()\n//       if(value){\n//          search(value);\n//           //console.log('fill')\n//       }else {\n//         //console.log('unfill');\n//         search('[]')\n//       }\n//   })\n\nbtnSearch.addEventListener('click', function (evt) {\n  var value = inputs.value.trim();\n\n  if (value) {\n    serviceApi(value);\n  } else {\n    serviceApi('[]');\n  }\n});\n\n//# sourceURL=webpack:///./src/index.js?");
